...
const LOCALE_STORAGE_KEY = 'gb-locale';
const THEME_STORAGE_KEY = 'gb-theme';
...
export default function Home() {
  ...
  const carouselControls =
    locale === 'pt-BR'
      ? {
          previousImpact: 'Capacidade anterior',
          nextImpact: 'Próxima capacidade',
          goToImpact: 'Ir para capacidade',
          previousRecommendation: 'Case anterior',
          nextRecommendation: 'Próximo case',
          goToRecommendation: 'Ir para case',
        }
      : {
          previousImpact: 'Previous capability',
          nextImpact: 'Next capability',
          goToImpact: 'Go to capability',
          previousRecommendation: 'Previous case study',
          nextRecommendation: 'Next case study',
          goToRecommendation: 'Go to case study',
        };

  useEffect(() => {
    const frameId = window.requestAnimationFrame(() => {
      setLocale(readInitialLocale());
      setThemePreference(readInitialThemePreference());
      setIsPreferenceSynced(true);
    });
  ...
  useEffect(() => {
    if (!isPreferenceSynced) {
      return;
    }

    document.documentElement.lang = locale;
    window.localStorage.setItem(LOCALE_STORAGE_KEY, locale);
  }, [isPreferenceSynced, locale]);
  ...
  }, [isPreferenceSynced, themePreference]);
  ...
  const phoneLink = content.contacts.phone?.replace(/\s+/g, '');
        ...
        <section id='top' className='pt-10 md:pt-16'>
          <div className='container'>
            <div className='hero-top-layout'>
              <div className='hero-copy-column space-y-8'>
            ...
            <div
              className='metric-grid hero-metric-grid'
              data-reveal
          ...
          <div className='container'>
            <div className='contact-panel' data-reveal style={revealStyle(120)}>
              ...
              >
                ...
                {phoneLink && (
                  <a href={`tel:${phoneLink}`} className='contact-item'>
